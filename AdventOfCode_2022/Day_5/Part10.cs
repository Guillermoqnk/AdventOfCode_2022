        ...
        public static async void Run()
        {
            ...
            foreach(var line in input)
            {
                if(line != "")
                {
                    ...
                    Stack<char> stack_x = new Stack<char>();
                    ...
                    for(int i = 1; i <= Convert.ToInt32(lineData[0]); i++)
                    {
                        ...
                        {
                            case 1:
                                stack_x.Push(stack_1.Pop());
                                break;

                            case 2:
                                stack_x.Push(stack_2.Pop());
                                break;

                            case 3:
                                stack_x.Push(stack_3.Pop());
                                break;

                            case 4:
                                stack_x.Push(stack_4.Pop());
                                break;

                            case 5:
                                stack_x.Push(stack_5.Pop());
                                break;

                            case 6:
                                stack_x.Push(stack_6.Pop());
                                break;

                            case 7:
                                stack_x.Push(stack_7.Pop());
                                break;

                            case 8:
                                stack_x.Push(stack_8.Pop());
                                break;

                            case 9:
                                stack_x.Push(stack_9.Pop());
                                break;
                    ...
                    {
                        MoveCrate(stack_x.Pop(), Convert.ToInt32(lineData[2]));
                    }
                }
            }
