            ...
            foreach(string line in input)
            {
                if(line != "")
                {
                    ...
                    if (((Int32.Parse(firstId[0]) <= Int32.Parse(secondId[0])) && (Int32.Parse(firstId[1]) >= Int32.Parse(secondId[1])))
                        ...
                        || ((Int32.Parse(firstId[0]) <= Int32.Parse(secondId[0])) && (Int32.Parse(firstId[1]) >= Int32.Parse(secondId[0])))
                        || ((Int32.Parse(firstId[0]) <= Int32.Parse(secondId[1])) && (Int32.Parse(firstId[1]) >= Int32.Parse(secondId[1]))))
                    {
                        totalSum += 1;
                    }
                }
